...
- 必ず最後に以下の免責事項とCTAを追加:
  「※塾頭による完全自動化への挑戦としてAIが投稿を生成しています。興味を持っていただけたら、ぜひお気軽にDMやプロフィールのリンクからご連絡ください。無料体験・ご相談お待ちしています！」
...
【投稿1: 情報提供型（人物なし画像の例）】
"明るい教室の机の上に、マインクラフトの画面が映し出されたノートPCが置かれている。画面にはカラフルなブロックで作られた建築物とプログラミングコードが表示されている。自然光が差し込み、温かい雰囲気。デスクには筆記用具とノートが整然と並んでいる。一貫性ルール1適用。","遊びから\\n学びへ","マインクラフト\\nで楽しく\\nプログラミング\\n習得","PCモニターに映る、AIプログラミングの実行画面。マインクラフトのキャラクターがAIの指示通りに自動で建築をしている様子。コードエディタも画面に表示され、プログラムの流れが可視化されている。知的で活気ある雰囲気。一貫性ルール1適用。","AI先生\\nが24時間","いつでも\\n質問できる\\n安心感","塾長がホワイトボードの前に立ち、プログラミングの基礎を説明している。ボードには「if文」の図解が描かれている。紺のスウェットシャツ姿で、明るい笑顔。自然光が差し込む。一貫性ルール1適用。","基礎から\\n丁寧に","初心者でも\\n安心して\\n学べる環境","CTOと塾頭が笑顔で並んで立っている。CTOは白いポロシャツとメガネ姿、塾頭はグレーのニット帽と黒いジャケット、赤いパーカー姿。背景にはif(塾)のロゴと「無料体験受付中」の文字。希望に満ちた雰囲気。一貫性ルール1適用。","まずは\\n無料体験","プログラミング\\nの楽しさを\\n体感しよう","「プログラミング、難しそう…」と思っていませんか？if(塾)では、マインクラフトを使って楽しくプログラミングを学べます。✅ゲーム感覚で基礎が身につく ✅AI先生が24時間サポート ✅実践的なスキルが習得できる。初心者でも安心の環境です。※塾頭による完全自動化への挑戦としてAIが投稿を生成しています。興味を持っていただけたら、ぜひお気軽にDMやプロフィールのリンクからご連絡ください。無料体験・ご相談お待ちしています！ #if塾 #オンラインプログラミング #AI学習 #マインクラフト教育 #プログラミング初心者 #STEAM教育 #習い事 #全国対応"

【投稿2: 講師紹介型】
"明るい教室で、塾長が笑顔で立っている。紺のスウェットシャツ姿で、手にはタブレット。背景には「未来を創る」というメッセージボード。温かく親しみやすい雰囲気。自然光が差し込む。一貫性ルール1適用。","塾長\\n紹介","教育と起業の\\n両方を知る\\nリーダー","CTOがPCの前に座り、複雑なコードを書いている様子。集中した表情だが、時折笑顔を見せる。白いポロシャツとメガネ姿。背景のモニターにはマインクラフトとAIシステムの統合画面。知的で活気ある雰囲気。一貫性ルール1適用。","技術の\\nCTO","AI開発の\\nプロフェッショナル\\nが直接指導","塾頭がタブレットを持ち、カメラに向かって優しい笑顔を見せている。グレーのニット帽、黒いジャケット、赤いパーカー姿。背景には「臨床心理士」「エンジニア」「コンサルタント」の文字。温かく落ち着いた雰囲気。一貫性ルール1適用。","心の\\nサポート","臨床心理士\\n経験が活きる\\n個別支援","塾長、CTO、塾頭の3人が笑顔で並んで立っている。背景にはif(塾)のロゴ。それぞれの個性が光る。チームとしての一体感。明るく希望に満ちた雰囲気。一貫性ルール1適用。","プロの\\nチーム","3人の専門家が\\nあなたを\\n全力で\\nサポート","if(塾)の講師陣は、それぞれが異なる専門性を持つプロフェッショナル。塾長（教育と起業）、CTO（AI・システム開発）、塾頭（心理サポート）。多角的な視点から「好き」を応援します。✅技術力 ✅ビジネス思考 ✅心のケア、全てが揃った環境です。※塾頭による完全自動化への挑戦としてAIが投稿を生成しています。興味を持っていただけたら、ぜひお気軽にDMやプロフィールのリンクからご連絡ください。無料体験・ご相談お待ちしています！ #if塾 #オンラインプログラミング #AI学習 #講師紹介 #メンター #プログラミング教育 #個別指導 #起業家育成"

【投稿3: 実績紹介型（人物なし画像の例）】
"PCモニターに映る、マインクラフトで作られた精巧な建築物。複雑な構造の城や街並みが、プログラミングによって自動生成されている様子。画面には「AI自動建築プログラム 完成」の文字。達成感に満ちた雰囲気。一貫性ルール1適用。","作品\\n紹介","プログラミング\\nで実現する\\n無限の創造力","学生起業家が自信に満ちた笑顔でプレゼンテーションをしている様子。スライドには自分が開発したアプリの画面。背景にはビジネスコンテストの会場。若々しくエネルギッシュな雰囲気。一貫性ルール1適用。","起業家\\n育成","ビジネス思考も\\n同時に学べる\\n実践的環境","Y君が配信用のヘッドセットをつけ、PCの前で真剣な表情でゲームをプレイしている。モニターにはeスポーツの競技画面。プロの道を目指す情熱が伝わる雰囲気。一貫性ルール1適用。","eスポーツ\\nの道","プロを目指す\\n仲間と共に\\n切磋琢磨","if(塾)のロゴと、これまでの実績を示す統計グラフ。「AI甲子園全国5位」「継続率90%」「作品完成率85%」などの数字が表示されている。信頼感のあるデザイン。明るく希望に満ちた雰囲気。一貫性ルール1適用。","確かな\\n実績","数字が証明する\\n質の高い\\n学習環境","if(塾)では、様々な目標を持つ仲間が学んでいます。AI開発、起業、eスポーツ、それぞれの夢に向かって成長中。✅AI甲子園全国5位の実績 ✅継続率90%の学習環境 ✅一人ひとりの目標に合わせたサポート。※塾頭による完全自動化への挑戦としてAIが投稿を生成しています。興味を持っていただけたら、ぜひお気軽にDMやプロフィールのリンクからご連絡ください。無料体験・ご相談お待ちしています！ #if塾 #オンラインプログラミング #AI学習 #起業家育成 #eスポーツ #実績 #プログラミング教育 #個別指導"
